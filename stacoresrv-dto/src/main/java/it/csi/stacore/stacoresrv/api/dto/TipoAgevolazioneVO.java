...
@ApiModel(description="TipoAgevolazione")

public class TipoAgevolazioneVO  implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    TipoAgevolazioneVO tipoAgevolazioneVO = (TipoAgevolazioneVO) o;
    return Objects.equals(decodifica, tipoAgevolazioneVO.decodifica);
  }
  ...
  public String toString() {
    ...
    sb.append("class TipoAgevolazioneVO {\n");
