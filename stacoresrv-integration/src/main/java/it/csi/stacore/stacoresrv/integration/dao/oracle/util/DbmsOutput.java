package it.csi.stacore.stacoresrv.integration.dao.oracle.util;
...
public class DbmsOutput {
   ...
   * using system.out * */
  /**
	 * @uml.property  name="enable_stmt"
	 */
  private CallableStatement enable_stmt;

  /**
	 * @uml.property  name="disable_stmt"
	 */
  private CallableStatement disable_stmt;

  /**
	 * @uml.property  name="show_stmt"
	 */
  ...
  public DbmsOutput(Connection conn) throws ResourceAccessException {
    try {
      ...
      throw new ResourceAccessException("Eccezione durante la preparazione degli statement.", e);
    }
  ...
  public void enable(int size) throws ResourceAccessException {
    try {

      enable_stmt.setInt(1, size);
      enable_stmt.executeUpdate();
    } catch (SQLException e) {
      throw new ResourceAccessException("Eccezione durante l'esecuzione di enable_stmt.", e);
    }
  ...
  public void disable() throws ResourceAccessException {
    try {
      disable_stmt.executeUpdate();
    } catch (SQLException e) {
      throw new ResourceAccessException("Eccezione durante l'esecuzione di disable_stmt.", e);
    }
  ...
  public String getOutput() throws ResourceAccessException {
    try {
      int done = 0;
      ...
      throw new ResourceAccessException("Eccezione durante la lettura di DbmsOutput.", e);
    }
  ...
  public void close() throws ResourceAccessException {
    try {
      ...
      throw new ResourceAccessException("Eccezione durante la chiusura di DbmsOutput.", e);
    }
  }
}
